...
import torch
import time
from sklearn.preprocessing import LabelEncoder  # Tambahkan ini untuk label_encoder
...
# Misalnya, ini hanya contoh. Ganti dengan daftar kode KBLI asli yang digunakan saat melatih model
kbli_codes = ["47771", "47772", "47773"]  # Contoh kode KBLI, sesuaikan dengan datasetmu
